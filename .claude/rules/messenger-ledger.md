...
- **НЕ сделал:** контакт→`project_participant` «Клиент» (доступы — отдельно, осознанно); кнопка в `PanelProjectInfoRow` (смена проекта у уже-проектных тредов) — пока только личные диалоги.
