          ...
          <div className="flex items-center gap-2 pointer-events-auto">
            ...
            {!state.editingMessage && (
              <button
                ...
                className="h-6 w-6 shrink-0 rounded-full border border-neutral-400 bg-white/80 backdrop-blur-sm shadow-[0_0_6px_2px_rgba(255,255,255,0.9)] flex items-center justify-center text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted/50"
              >
                @
              </button>
            )}
