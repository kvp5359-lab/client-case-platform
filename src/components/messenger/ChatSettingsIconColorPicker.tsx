...
/** Сетки цвета и иконки — без popover-обёртки. Переиспользуется в нескольких триггерах. */
export function ChatIconColorGrid({
  accentColor,
  icon,
  onAccentColorChange,
  onIconChange,
...
export function ChatSettingsIconColorPicker(props: PickerProps) {
  const { accentColor, icon } = props
