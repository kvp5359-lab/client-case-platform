-- Добавляем start_at и end_at в возврат get_workspace_threads,
-- чтобы клиент мог восстанавливать длительность задачи в пикере срока
-- (TaskTimePickerPopover).
--
-- Изменение сигнатуры → DROP + CREATE.

DROP FUNCTION public.get_workspace_threads(uuid, uuid);
