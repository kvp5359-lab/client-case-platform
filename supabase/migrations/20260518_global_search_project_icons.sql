-- Расширяем RPC: возвращаем project_template_id + project_status_id, чтобы фронт
-- мог резолвить иконку проекта (через те же кэши useSidebarData —
-- sidebarMetaKeys.templatesIcons / statusesColors).
