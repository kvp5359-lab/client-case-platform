-- Синхронизируем секрет в триггере БД с env-переменной edge-функции.
--
-- Триггер шлёт x-internal-secret через net.http_post в telegram-send-message.
-- Значение в триггере разошлось с INTERNAL_FUNCTION_SECRET (vault) — все
-- входящие сообщения из ЛК отбивались с 401. Ставим актуальное значение
-- из vault, чтобы триггер и edge-функция совпали.
