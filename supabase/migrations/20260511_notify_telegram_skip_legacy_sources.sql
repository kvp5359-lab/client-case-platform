-- Регрессия: при последних переписываниях триггера из skip-листа выпали
-- legacy-источники 'telegram' и 'bot_event'. В результате входящее сообщение
-- из группы (бот сохраняет с source='telegram') триггерилось обратно через
-- telegram-send-message и бот постил эхо. Возвращаем оба значения.
